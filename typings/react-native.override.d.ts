...
declare module "react-native" {
  ...
  declare const ToolbarAndroidBase: Constructor<NativeMethods> &
  ...
  declare const SegmentedControlIOSBase: Constructor<NativeMethods> &
  ...
  declare const PickerIOSBase: Constructor<NativeMethods> &
