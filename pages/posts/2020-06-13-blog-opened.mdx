...
export const meta = {
  ...
  color1: "#00D5FF",
  color2: "#FFE641",
  createdAt: parse("2020-06-13 00:00:00 +09:00", "yyyy-MM-dd HH:mm:ss XXX", new Date()),
  author: "@gaishimo",
  description: "ブログを新たに開設しました。",
  imagePath: "/ogImage.png",
  lastUpdatedAt: parse("2020-06-20 10:36:00 +09:00", "yyyy-MM-dd HH:mm:ss XXX", new Date()),
}
...
<ImageWrapper width="50%">
  <img alt="テンプレート表示" src="/ogImage.png" width={"100%"} height="auto" />
</ImageWrapper>


Omoidasu, Inc.では[omoidasu](https://omoidasu.app)というアプリを開発しているのですが、開発の際のノウハウや調査等の情報をここに残していきたいと思います。
...
<ImageWrapper width="80%">
  <img alt="テンプレート表示" src="/posts/2020-06-13-blog-opened/page-example1.png" width={"100%"} height="auto" />
</ImageWrapper>
...
<ImageWrapper width="80%">
  <img alt="記事リスト" src="/posts/2020-06-13-blog-opened/list1.png" width={"100%"} height="auto" />
</ImageWrapper>
