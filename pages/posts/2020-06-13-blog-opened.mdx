...
export const meta = {
  ...
  lastUpdatedAt: new Date("2020-06-13 16:03:00"),
}
...
<ImageWrapper width="80%">
  <img src="/posts/2020-06-13-blog-opened/page-example1.png" width={"100%"} height="auto" />
</ImageWrapper>
...
さらにiタグのエレメントを見出しの前に追加することで左にリンクアイコンを表示しています(アイコンはfont-awesomeを利用しました。

```html
<h2><a href="#見出し1">見出し1</a></h2>
```
...
<ImageWrapper width="80%">
  <img src="/posts/2020-06-13-blog-opened/list1.png" width={"100%"} height="auto" />
</ImageWrapper>
