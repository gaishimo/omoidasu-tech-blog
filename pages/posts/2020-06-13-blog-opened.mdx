...
export const meta = {
  ...
  lastUpdatedAt: parse("2021-09-17 12:13:00 +09:00", "yyyy-MM-dd HH:mm:ss XXX", new Date()),
}
...
<ImageWrapper width="100%" maxWidth={400} sourceUri="/ogImage.png"  />
...
<ImageWrapper width="80%" maxWidth={800} alt="記事リスト" sourceUri="/posts/2020-06-13-blog-opened/list1.png"  />
