...
<ImageWrapper width={180}>
  <img alt="Provisioning Profileをダウンロード" src="/posts/2021-06-04-hello-eas-build-managed/downloadProfile.jpeg" width={"100%"} height="auto" />
</ImageWrapper>
...
<ImageWrapper width={180}>
  <img alt="EASビルド画面からアプリをダウンロード" src="/posts/2021-06-04-hello-eas-build-managed/installApp.jpeg" width={"100%"} height="auto" />
</ImageWrapper>
...
<ImageWrapper width={180}>
  <img alt="端末ホーム画面に追加されたアプリ" src="/posts/2021-06-04-hello-eas-build-managed/installedApp.jpeg" width={"100%"} height="auto" />
</ImageWrapper>
...
<ImageWrapper width={180}>
  <img alt="起動されたアプリ" src="/posts/2021-06-04-hello-eas-build-managed/launchedApp.jpeg" width={"100%"} height="auto" />
</ImageWrapper>

そして驚くべきはアプリサイズです。

<ImageWrapper width={260}>
  <img alt="起動されたアプリ" src="/posts/2021-06-04-hello-eas-build-managed/appSize.png" width={"100%"} height="auto" />
</ImageWrapper>
...
<ImageWrapper width={180}>
  <img alt="更新されたアプリ" src="/posts/2021-06-04-hello-eas-build-managed/updatedApp.jpeg" width={"100%"} height="auto" />
</ImageWrapper>
