...
[https://twitter.com/JI/status/1629242602590715904](https://twitter.com/JI/status/1629242602590715904)
...
これについてはExpoブログの以下の記事で記載があります。[https://blog.expo.dev/a-peek-into-the-upcoming-sweet-expo-module-api-6de6b9aca492](https://blog.expo.dev/a-peek-into-the-upcoming-sweet-expo-module-api-6de6b9aca492)
...
[https://github.com/expo/expo/pull/18272](https://github.com/expo/expo/pull/18272)
...
[https://docs.expo.dev/modules/module-api/#function](https://docs.expo.dev/modules/module-api/#function)
[https://docs.expo.dev/modules/module-api/#asyncfunction](https://docs.expo.dev/modules/module-api/#asyncfunction)
...
公式Docのサンプルコード: [https://docs.expo.dev/modules/module-api/#sending-events](https://docs.expo.dev/modules/module-api/#sending-events)
...
公式Docのサンプルコード: [https://docs.expo.dev/modules/module-api/#view-callbacks](https://docs.expo.dev/modules/module-api/#view-callbacks)
...
[https://docs.expo.dev/modules/overview/](https://docs.expo.dev/modules/overview/)

また、以下で実際にexpoが作成したExpo Modulesの一覧を確認することが可能ですので、より実践的なサンプルコードを確認したい時参考になると思います。
[https://docs.expo.dev/modules/module-api/#examples](https://docs.expo.dev/modules/module-api/#examples)


## 参考資料

- [Expo Modules API: Overview - Expo Documentation]([https://docs.expo.dev/modules/overview/](https://docs.expo.dev/modules/overview/))
- [Expo Modules API: Get started - Expo Documentation](https://docs.expo.dev/modules/get-started/)
- [Module API Reference - Expo Documentation]([https://docs.expo.dev/modules/module-api/](https://docs.expo.dev/modules/module-api/))
