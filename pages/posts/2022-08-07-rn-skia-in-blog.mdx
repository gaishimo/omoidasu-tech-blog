...
export const meta = {
  ...
  tagNames: ["react-native-skia", "next.js", "react-native", "skia"],
  color1: "#4CC8F0",
  color2: "#3B8FFD",
  createdAt: parse(
  ...
  author: "@gaishimo",
  description: "2DグラフィックライブラリをReact Nativeで扱うためのreact-native-skiaを当ブログに導入しました",
  imagePath: "/posts/2022-08-07-rn-skia-in-blog/image.png",
  lastUpdatedAt: parse(
    "2022-08-07 16:58:00 +09:00",
    "yyyy-MM-dd HH:mm:ss XXX",
    new Date(),
  ),
}
