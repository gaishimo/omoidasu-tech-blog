...
Skiaでベジェ曲線を使って描画しています。3次ベジェ曲線については以前の記事[react-native-skiaで三次ベジェ曲線を描く](http://blog.omoidasu.dev/posts/2022-09-21-cubic-bezier-curve)で解説しています。


Pathの子要素に`Shadow`を配置し、ドロップシャドウを追加しています。
