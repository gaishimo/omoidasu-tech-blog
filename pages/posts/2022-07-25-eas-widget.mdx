...
<ImageWrapper width="80%" maxWidth={240} alt="ウィジェットのイメージ" style={{ marginVertical: 40 }} sourceUri="/posts/2022-07-25-eas-widget/widget_image.webp" />
...
<ImageWrapper width="80%" alt="Android StudioでのWidgetの追加1" style={{ marginVertical: 24 }} sourceUri="/posts/2022-07-25-eas-widget/android_studio_add_widget1.webp" />

<ImageWrapper width="80%" maxWidth={500} alt="Android StudioでのWidgetの追加2" style={{ marginVertical: 24 }} sourceUri="/posts/2022-07-25-eas-widget/android_studio_add_widget2.webp" />
...
<ImageWrapper width="90%" maxWidth={240} alt="AndroidでのWidget起動" style={{ marginVertical: 40 }} sourceUri="/posts/2022-07-25-eas-widget/android_widget_home.webp" />
...
<ImageWrapper width="80%" alt="XCodeでWidgetを追加1" style={{ marginVertical: 40 }} sourceUri="/posts/2022-07-25-eas-widget/xcode_add_target1.webp" />

<ImageWrapper width="80%"  alt="XCodeでWidgetを追加2" style={{ marginVertical: 40 }} sourceUri="/posts/2022-07-25-eas-widget/xcode_add_target2.webp" />
...
<ImageWrapper width="90%" maxWidth={300} alt="iOSでのWidget起動" style={{ marginVertical: 40 }} sourceUri="/posts/2022-07-25-eas-widget/ios_widget1.webp" />

<ImageWrapper width="90%" maxWidth={300} alt="iOSでのWidget起動" style={{ marginVertical: 40 }} sourceUri="/posts/2022-07-25-eas-widget/ios_widget2.webp" />
