...
export const meta = {
  ...
  author: "@gaishimo",
  description:
    "当ブログ(Next.js)にReact Native for Webを導入しました。",
...
タップ(クリック)するとボタンの状態が変化しそのまま長押しし続けると更に変化します。簡単なものですが、このようなアプリっぽいインタラクティブを用意に記述できます。今後もこのブログに、React Nativeの動きのあるサンプルをどんどん載せていきたいと思います。
